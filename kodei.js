...
var typed = new Typed('.typing', { strings: ["", "Web Designer", "Web Developer", "Graphic Designer", "Youtuber", "Tiktokers"], typeSpeed: 100, Backspeed: 60, loop: true })
...
function asideSectionTogglerBtn(){
 ...
 const music = document.getElementById("bg-music");
  ...
  // Coba autoplay dengan paksa ketika halaman selesai dimuat
  window.addEventListener("DOMContentLoaded", () => {
    music.play().then(() => {
      isPlaying = true;
    }).catch((e) => {
      // Kalau autoplay gagal, tandai sebagai tidak aktif
      isPlaying = false;
      musicIcon.classList.remove("fa-volume-down");
